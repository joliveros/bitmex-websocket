...
class TestInstrument(object):
    def test_average_latency(self, mocker):
        """
        ...
        instrument = Instrument(should_auth=True)
    ...
    # def test_on_partial_action_instrument_data(self, mocker):
    ...
    # def test_on_update_action_instrument_data(self, mocker):
    #     init_mock = mocker.patch('bitmex_websocket.Instrument.init')
    #
    #     partial_message = instrument_data['partial']
